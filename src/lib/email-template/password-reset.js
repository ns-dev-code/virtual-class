 ...
 function ForgotPassword(userDetails){
    ...
    const email = `
            ...
            <tbody>
                ...
                <tr><td><br/><a href="${url}/reset-password/userName=${userDetails.firstName}&&userId=${userDetails.uid}" style="text-decoration: none; color: #066d66; color: crimson; font-size: larger;">Reset my password</a></td></tr>
